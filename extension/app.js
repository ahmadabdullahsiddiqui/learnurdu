...
const TOPICS = [
  ...
  },
  {
    ...
    items: [
      ...
      ['3', 'تین', 'tīn', 'Urdu numeral: ۳'],
      ['4', 'چار', 'chār', 'Urdu numeral: ۴'],
      ['5', 'پانچ', 'pānch', 'Urdu numeral: ۵'],
      ['6', 'چھ', 'chhe', 'Urdu numeral: ۶'],
      ['7', 'سات', 'sāt', 'Urdu numeral: ۷'],
      ['8', 'آٹھ', 'āṭh', 'Urdu numeral: ۸'],
      ['9', 'نو', 'nau', 'Urdu numeral: ۹'],
      ['10', 'دس', 'das', 'Urdu numeral: ۱۰'],
      ['11', 'گیارہ', 'gyārah', 'Urdu numeral: ۱۱'],
      ['12', 'بارہ', 'bārah', 'Urdu numeral: ۱۲'],
      ...
      ['18', 'اٹھارہ', 'aṭhārah', 'Urdu numeral: ۱۸'],
      ['19', 'انیس', 'unnīs', 'Urdu numeral: ۱۹'],
      ['20', 'بیس', 'bīs', 'Urdu numeral: ۲۰'],
      ['21', 'اکیس', 'ikkīs', 'Urdu numeral: ۲۱'],
      ['22', 'بائیس', 'bāīs', 'Urdu numeral: ۲۲'],
      ['23', 'تئیس', 'teīs', 'Urdu numeral: ۲۳'],
      ['24', 'چوبیس', 'chaubīs', 'Urdu numeral: ۲۴'],
      ['25', 'پچیس', 'pachchīs', 'Urdu numeral: ۲۵'],
      ['26', 'چھببیس', 'chhabbīs', 'Urdu numeral: ۲۶'],
      ['27', 'ستائیس', 'sattāīs', 'Urdu numeral: ۲۷'],
      ['28', 'اٹھائیس', 'aṭhāīs', 'Urdu numeral: ۲۸'],
      ['29', 'انتیس', 'untīs', 'Urdu numeral: ۲۹'],
      ['30', 'تیس', 'tīs', 'Urdu numeral: ۳۰'],
      ['31', 'اکتیس', 'iktīs', 'Urdu numeral: ۳۱'],
      ['32', 'بتیس', 'battīs', 'Urdu numeral: ۳۲'],
      ['33', 'تینتیس', 'taiṅtīs', 'Urdu numeral: ۳۳'],
      ['34', 'چونتیس', 'chauṅtīs', 'Urdu numeral: ۳۴'],
      ['35', 'پینتیس', 'paiṅtīs', 'Urdu numeral: ۳۵'],
      ['36', 'چھتیس', 'chhattīs', 'Urdu numeral: ۳۶'],
      ['37', 'سینتیس', 'saiṅtīs', 'Urdu numeral: ۳۷'],
      ['38', 'اڑتیس', 'aṛtīs', 'Urdu numeral: ۳۸'],
      ['39', 'انتالیس', 'untālīs', 'Urdu numeral: ۳۹'],
      ['40', 'چالیس', 'chālīs', 'Urdu numeral: ۴۰'],
      ['41', 'اکتالیس', 'iktālīs', 'Urdu numeral: ۴۱'],
      ['42', 'بیالیس', 'bayālīs', 'Urdu numeral: ۴۲'],
      ['43', 'تینتالیس', 'taiṅtālīs', 'Urdu numeral: ۴۳'],
      ['44', 'چوالیس', 'chawālīs', 'Urdu numeral: ۴۴'],
      ['45', 'پینتالیس', 'paiṅtālīs', 'Urdu numeral: ۴۵'],
      ['46', 'چھیالیس', 'chhiyālīs', 'Urdu numeral: ۴۶'],
      ['47', 'سینتالیس', 'saiṅtālīs', 'Urdu numeral: ۴۷'],
      ['48', 'اڑتالیس', 'aṛtālīs', 'Urdu numeral: ۴۸'],
      ['49', 'انچاس', 'unchās', 'Urdu numeral: ۴۹'],
      ['50', 'پچاس', 'pachās', 'Urdu numeral: ۵۰'],
      ['51', 'اکاون', 'ikāwan', 'Urdu numeral: ۵۱'],
      ['52', 'باون', 'bāwan', 'Urdu numeral: ۵۲'],
      ...
      ['57', 'ستاون', 'sattāwan', 'Urdu numeral: ۵۷'],
      ['58', 'اٹھاون', 'aṭhāwan', 'Urdu numeral: ۵۸'],
      ['59', 'انسٹھ', 'unsaṭh', 'Urdu numeral: ۵۹'],
      ['60', 'ساٹھ', 'sāṭh', 'Urdu numeral: ۶۰'],
      ['61', 'اکسٹھ', 'iksaṭh', 'Urdu numeral: ۶۱'],
      ['62', 'باسٹھ', 'bāsaṭh', 'Urdu numeral: ۶۲'],
      ['63', 'ترسٹھ', 'tirsaṭh', 'Urdu numeral: ۶۳'],
      ['64', 'چوسٹھ', 'chauṅsaṭh', 'Urdu numeral: ۶۴'],
      ['65', 'پینسٹھ', 'paiṅsaṭh', 'Urdu numeral: ۶۵'],
      ['66', 'چھیاسٹھ', 'chhiyāsaṭh', 'Urdu numeral: ۶۶'],
      ['67', 'سترسٹھ', 'satsaṭh', 'Urdu numeral: ۶۷'],
      ['68', 'اڑسٹھ', 'aṛsaṭh', 'Urdu numeral: ۶۸'],
      ...
      ['78', 'اٹھہتر', 'aṭhhattar', 'Urdu numeral: ۷۸'],
      ['79', 'اناسی', 'unāsī', 'Urdu numeral: ۷۹'],
      ['80', 'اسی', 'assī', 'Urdu numeral: ۸۰'],
      ['81', 'اکیاسی', 'ikyāsī', 'Urdu numeral: ۸۱'],
      ['82', 'بیاسی', 'bayāsī', 'Urdu numeral: ۸۲'],
      ['83', 'تراسی', 'tirāsī', 'Urdu numeral: ۸۳'],
      ['84', 'چوراسی', 'chaurāsī', 'Urdu numeral: ۸۴'],
      ['85', 'پچاسی', 'pachāsī', 'Urdu numeral: ۸۵'],
      ['86', 'چھیاسی', 'chhiyāsī', 'Urdu numeral: ۸۶'],
      ['87', 'ستاسی', 'satāsī', 'Urdu numeral: ۸۷'],
      ['88', 'اٹھاسی', 'aṭhāsī', 'Urdu numeral: ۸۸'],
      ['89', 'نواسی', 'nawāsī', 'Urdu numeral: ۸۹'],
      ['90', 'نوے', 'nawwe', 'Urdu numeral: ۹۰'],
      ['91', 'اکانوے', 'ikānwe', 'Urdu numeral: ۹۱'],
      ['92', 'بانوے', 'bānwe', 'Urdu numeral: ۹۲'],
      ['93', 'ترانوے', 'tirānwe', 'Urdu numeral: ۹۳'],
      ['94', 'چورانوے', 'chaurānwe', 'Urdu numeral: ۹۴'],
      ['95', 'پچانوے', 'pachānwe', 'Urdu numeral: ۹۵'],
      ['96', 'چھیانوے', 'chhiyānwe', 'Urdu numeral: ۹۶'],
      ['97', 'ستانوے', 'satānwe', 'Urdu numeral: ۹۷'],
      ['98', 'اٹھانوے', 'aṭhānwe', 'Urdu numeral: ۹۸'],
      ['99', 'ننانوے', 'ninānwe', 'Urdu numeral: ۹۹'],
  ...
  },
  {
    ...
    items: [
      ...
      ['clothes', 'کپڑے', 'kapṛe'],
      ['shoes', 'جوتے', 'jūte'],
      ['light', 'روشنی', 'roshnī', 'A bright, poetic word.']
    ]
  },
  {
